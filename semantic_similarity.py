...
# Try importing spaCy and loading the models
try:
    import spacy
    ...
    print("spaCy English model (en_core_web_md) loaded successfully.")
except ImportError as e:
    print(f"Error: {e}")
    print("spaCy is not installed. Please install it using 'pip install spacy'.")
except OSError as e:
    print(f"Error: {e}")
    print("The spaCy English model 'en_core_web_md' is not installed. Please install it using 'python -m spacy download en_core_web_md'.")
...
# Load the simpler language model
...
# Add your observations and example
print("\nObservations:")
print("The medium model ('en_core_web_md') provides more nuanced similarity scores between words and sentences compared to the smaller model ('en_core_web_sm'). For instance, the similarity between 'cat' and 'monkey' is higher in 'en_core_web_md' due to its larger vocabulary and more advanced word vectors.")

print("\nExample:")
print("Comparing 'apple' and 'fruit' shows that they are related concepts, with a high similarity score. This demonstrates that 'en_core_web_md' can capture semantic relationships between words better than 'en_core_web_sm'.")
